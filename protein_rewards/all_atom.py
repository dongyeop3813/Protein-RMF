...
import torch
from protein_rewards import residue_constants
from openfold.utils import rigid_utils as ru
from protein_rewards import data_transforms
from openfold.utils import feats
from protein_rewards import utils as du
...
def to_atom37(trans, rots):
    ...
    final_atom37, atom37_mask, aatype, atom14_pos = compute_backbone(
        du.create_rigid(rots, trans),
        torch.zeros(num_batch, num_res, 2, device=trans.device)
    )

    return final_atom37, atom37_mask, aatype
