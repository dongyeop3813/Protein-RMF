...
from models.module.test_true_regression import TestTrueRegressionModule
...
class Experiment(eu.BaseExperiment):
    def __init__(self, *, cfg: DictConfig):
        super().__init__(cfg=cfg)
        self.module: LightningModule = TestTrueRegressionModule(self.cfg)


@hydra.main(version_base=None, config_path="../configs", config_name="semi_mf.yaml")
